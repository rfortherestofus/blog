...
For example, for our [Oregon Voices consulting project](https://orvoices.org/your-county/), it was invaluable to have a great package that allows to create nice charts of the US.
...
While we're working on the legend we might as well change it's title.
