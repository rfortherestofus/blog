...
```{r line graph with labels above line, no smoothing}
#| message: false
#| warning: false
...
```{r line graph with labels above line, 75 smoothing}
#| message: false
#| warning: false
...
```{r line graph with labels above line, 25 smoothing}
#| message: false
#| warning: false
...
```{r line graph with labels above line, 40 smoothing}
#| message: false
#| warning: false
...
It would also be useful to add lines showing what our fixed costs are and how many units we need to sell to break even. 
