...
First, to make our code easier, let's create variables with the information about the region we want to highlight. For this we need: the last year, the maximum value of both Australia and Japan, and then the difference between them.
